...
//
// 3. ACCEPTED DONATION TABLE
//
export const acceptedDonation = pgTable("accepted_donation", {
  acceptedId: uuid("accepted_id").defaultRandom().primaryKey(),

  donationId: uuid("donation_id")
    .notNull()
    .references(() => donation.donationId, { onDelete: "cascade" }),
